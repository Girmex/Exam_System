...
<body style="display:flex">
	...
	<div class="container-fluid admin">
		...
		<button class="btn btn-primary bt-sm" id="new_teacher"><i class="fa fa-plus"></i>	Add New</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tbody>
					<?php
					$qry = $conn->query("SELECT t.*,u.name from teachers t left join users u  on t.user_id = u.id order by u.name asc ");
					$i = 1;
					if($qry->num_rows > 0){
					...
					<tr>
						...
						<td>
							<center>
							 <button class="btn btn-sm btn-outline-primary edit_teacher" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i> Edit</button>
							<button class="btn btn-sm btn-outline-danger remove_teacher" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-trash"></i> Delete</button>
							</center>
						</td>
					</tr>
					<?php
